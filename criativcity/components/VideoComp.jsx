...
>>>>>>> 7ac22bfdd729c0497e8433e32345888436c4bbc4
...
>>>>>>> 7ac22bfdd729c0497e8433e32345888436c4bbc4
   ...
   return (
      <>
<<<<<<< HEAD
         <SkeletonTheme baseColor="#ebebeb" highlightColor="#cbcbcb">
            <section className="navbarbg pt-24 text-white font-Lato pb-24">
               <div className="grid grid-cols-1 lg:grid-cols-3  gap-4 mx-8 lg:mx-12">
                  <div className=" border-fuchsia-400 col-span-2 border- rounded-lg mx-4 lg:w-[100%]">
...
<<<<<<< HEAD
                  ...
                  {data.map((item, index) => (
                     <div className="space-y-4 mx-4 border-[0px] pr-[20px] " key={index}>
                        ...
                        <div
                           className="space-y-4 border- border-red-300 py-2 px-1 no-scrollbar overflow-scroll max-h-[550px]"
