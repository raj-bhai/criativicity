         ...
         <div className="faqqna navbarbg lg:space-y-5 space-y-2 mt-3 ">
            ...
            >
               <h3 className="text-white relative flex items-center justify-between text-[0.9rem] lg:text-[1.8rem]  font-Lato">
                  ...
                  {show[1] ? <IoIosArrowUp size={45} className="border-[0.02rem] rounded-md  border-fuchsia-400 px-2 py-2"></IoIosArrowUp> : <IoIosArrowDown size={45} className="border-[0.02rem] rounded-md  border-fuchsia-400 px-2 py-2"></IoIosArrowDown>}
               </h3>
