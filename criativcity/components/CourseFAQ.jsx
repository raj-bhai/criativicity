   ...
   return (
      <section className="flex relative items-center  flex-col justify-center pt-[3rem] lg:pt-[12rem] pb-4">
         ...
         <div className="faqqna lg:space-y-5 space-y-2 mt-3 ">
            <div
               className="border-2 rounded-lg border-fuchsia-50 px-4 py-3 "
               onClick={() => {
                  handleShow(1);
               }}
            >
               <h3 className="text-white relative flex items-center justify-between text-[0.9rem] lg:text-[1.8rem] font-Lato">
                  Master industry-standard software, &quot;Adobe Premiere Pro&quot;
                  {show[1] ? <IoIosArrowUp className=""></IoIosArrowUp> : <IoIosArrowDown className=""></IoIosArrowDown>}
               </h3>
            ...
            >
               <h3 className="text-white text-[0.9rem] flex items-center justify-between lg:text-[1.8rem] font-Lato">
                  ...
                  {show[2] ? <IoIosArrowUp className=""></IoIosArrowUp> : <IoIosArrowDown className=""></IoIosArrowDown>}
               </h3>
               {show[2] && (
                  <div className="text-left text-white font-Lato lg:text-[1.2rem] text-[0.9rem]">
                     <h6>- Edit and enhance video footage </h6>
            ...
            >
               <h3 className="text-white text-[0.9rem] items-center flex justify-between lg:text-[1.8rem] font-Lato">
                  ...
                  {show[3] ? <IoIosArrowUp className=""></IoIosArrowUp> : <IoIosArrowDown className=""></IoIosArrowDown>}
               </h3>
               {show[3] && (
                  <div className="text-left text-white font-Lato lg:text-[1.2rem] text-[0.9rem]">
                     <h6>- Edit and enhance video footage </h6>
            ...
            >
               <h3 className="text-white text-[0.9rem] items-center flex justify-between lg:text-[1.8rem] font-Lato">
                  ...
                  {show[4] ? <IoIosArrowUp className=""></IoIosArrowUp> : <IoIosArrowDown className=""></IoIosArrowDown>}
               </h3>
               {show[4] && (
                  <div className="text-left text-white font-Lato lg:text-[1.2rem] text-[0.9rem]">
                     <h6>- Edit and enhance video footage </h6>
