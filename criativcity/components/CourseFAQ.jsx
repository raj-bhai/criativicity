...
const CourseFAQ = () => {
   return (
      <section className="flex items-center  flex-col justify-center pt-[3rem] lg:pt-[8rem] pb-4">
         ...
         <div className="faqqna lg:space-y-5 space-y-2">
            <div className="border-2 rounded-lg border-fuchsia-50 px-4 py-3 ">
               <h3 className="text-white text-[0.7rem] lg:text-[1.8rem] font-Lato">Master industry-standard software, "Adobe Premiere Pro"</h3>
            </div>
            <div className="border-2 rounded-lg border-fuchsia-50 px-4 py-3">
               <h3 className="text-white text-[0.7rem] lg:text-[1.8rem] font-Lato">Understand the Psychology behind Editing</h3>
            </div>
            <div className="border-2 rounded-lg border-fuchsia-50 px-4 py-3">
               <h3 className="text-white text-[0.7rem] lg:text-[1.8rem] font-Lato">Decoding Youtubers and industries</h3>
            </div>
            <div className="border-2 rounded-lg border-fuchsia-50 px-4 py-3">
               <h3 className="text-white text-[0.7rem] lg:text-[1.8rem] font-Lato">Businesses With Editing</h3>
            </div>
         </div>
      </section>
   );
