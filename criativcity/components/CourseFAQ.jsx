...
const CourseFAQ = () => {
   ...
   return (
      <section className="flex relative items-center  flex-col justify-center pt-[3rem] lg:pt-[12rem] pb-4">
         <Image src={rectange} alt="rectange" className="absolute lg:w-44 lg:h-44 w-20 h-20 left-3 top-2 animate-slow "></Image>
         <Image src={polygon} alt="polygon" className=" absolute right-12 top-2 lg:w-16 lg:h-16 w-8 h-8 animate-slow "></Image>
