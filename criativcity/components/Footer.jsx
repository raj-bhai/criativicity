  ...
  return (
    <section className="font-Lato w-full navbarbg  px-12 py-6 flex lg:flex-row flex-col text-white items-start justify-between">
      <div className="leftlogotext ">
        ...
        <h3 className="cursor-pointer" onClick={() => router.push('/privacy')} >Privacy</h3>
        <h3 className="cursor-pointer" onClick={() => router.push('/terms')}  >Terms and Conditions</h3>
        <h3 >2023 Copyright</h3>
      </div>
      <div className="aboutus">
        <h3 className="cursor-pointer" onClick={() => router.push('/returnPolicy')} >Return Policy</h3>
